...
use Cetaf\Bundle\CrawlerBundle\Form\ShopType;
...
class ShopController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CetafCrawlerBundle:Shop')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CetafCrawlerBundle:Shop')->find($id);
     ...
     * @Method("POST")
     * @Template("CetafCrawlerBundle:Shop:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("CetafCrawlerBundle:Shop:edit.html.twig")
     */
